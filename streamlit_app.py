...
st.markdown("<img src='https://cdn.dribbble.com/users/513906/screenshots/5384407/dribbb.gif'  class='center' alt='Employee data' width='500' height='350' title='Employee Data title'>", unsafe_allow_html=True)
