...
st.markdown("<img src='https://cdn.dribbble.com/users/513906/screenshots/5384407/dribbb.gif' alt='Employee data' width='400' height='300' title='Employee Data title'>", unsafe_allow_html=True)
