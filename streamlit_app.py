...
st.markdown("<img src='https://cdn.dribbble.com/users/238057/screenshots/4688471/comp-1_1.gif' alt='Employee data' width='50' height='60' title='Employee Data title'>", unsafe_allow_html=True)
